...
- (UICollectionView *)carouselView {
    if(!_carouselView) {
//        self.carouselView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.addHeight * 0.5, self.frame.size.width - 20, self.frame.size.height - self.addHeight) collectionViewLayout:self.flowLayout];
